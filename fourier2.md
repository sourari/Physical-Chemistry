...
In the previous [page](/fourier.md) I have introduced mathematically what is a Fourier Transform. Here I will build from that  some visualizations that will help build the intuition of how Fourier Transforms work.
